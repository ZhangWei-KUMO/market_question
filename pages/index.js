...
class Home extends Component {
  static async getInitialProps() {
    try {
      const resRecom = await fetch(`${API_HOST}/recommendation`);
      const resHotTeachers = await fetch(`${API_HOST}/hot_teachers`);
      const resFreeList = await fetch(`${API_HOST}/free_list`);
      ...
      <div>
        ...
        <div className={styles.bannerContainer}>
          <div className={styles.bannerBox}>
            ...
            <video src={URL} muted autoPlay autoSave="true" loop className={styles.video} />
          </div>
        </div>
